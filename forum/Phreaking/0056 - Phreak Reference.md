...
(Note: This is from a thread on the old forums, which as of this writing can
still be found [here](http://www.phx2600.org/forum/viewtopic.php?t=837). Mad
props and all credit go to the original contributers, in alphabetical order:
Disposable, Sgnome, and Zapperlink)
...
**Links**
  ...
  * Bell's Mind - <http://www.bellsmind.net/>
  * NANPA - <http://www.nanpa.com/>
  * Old Skool Phreak - <http://www.oldskoolphreak.com/>
  * Phone Trips - <http://www.wideweb.com/phonetrips/>
  * Phreaksearch - <http://invasion.digitalgalileo.com/phreak/phreaksearch.htm>
  * Strom Carlson - <http://www.stromcarlson.com/">
  * Telcodata - <http://telcodata.us/>
  * Telefonia - <http://www.messaggeri.it/xtelefonia.htm>
  * Telephreak - <http://www.telephreak.org/>
  * DoD Secure Telecommunications and Defense Red Switch Network Security
    Technical Implementation Guide -
    <https://powhatan.iiie.disa.mil/techguid/DRSN_STIG_V1R1.pdf>

**VoIP Providers**

  * Broadvoice - <http://www.broadvoice.com/>
  * NuFone - <https://www.nufone.net/>
...
**VoIP Links**
  ...
  * SIPfoundry Open Source PBX - <http://www.sipfoundry.org/>
  * voip-info.org - <http://www.voip-info.org/wiki/>
  * VoIP Providers List - <http://www.voipproviderslist.com/>
  * Voip Security Blog - <http://www.voip-security-blog.com/>
  ...
  * VoIP Security Technical Implementation Guide -
    ...
    <http://iase.disa.mil/stigs/stig/voip-stig-v2r2-memo.doc>


**VoIP Reference**

  * VoIP - Voice over Internet Protocol, describes the ability to communicate by
    voice over the internet using a combination of technologies.
  * SIP - Session Initiation Protocol, uses RTP (Real-time Transport Protocol? I
    forget.) over TCP and UDP port(s) 5060. Tappable via packet-monitoring
    software such as Ethereal.
  * IAX - Inter Asterisk Exchange, uses a single UDP port 4569. Works better in
    NAT environs than SIP.
  * Softphone - Abbreviation for a VOIP Software Phone. Examples include
