...
It says:
[i:dxmzwwpv]To Disable CD autoplay, completely, in Windows XP Pro
...
All material © 2003 Doug Knox [/i:dxmzwwpv]
...
[b:dxmzwwpv]It appears that what one has to do to is mark the USB filesystem where you have the disable-proof autoplay stored as being CDFS rather than, say, FAT32. Then, Windows gleefully assumes its dealing not with USB Flash, but rather a CDROM hooked up over USB.[/b:dxmzwwpv]
