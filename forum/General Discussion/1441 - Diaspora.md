...
woot <!-- s:P --><img src="{SMILIES_PATH}/icon_razz.gif" alt=":P" title="Razz" /><!-- s:P -->
...
PS.
Invite me <!-- s;) --><img src="{SMILIES_PATH}/icon_e_wink.gif" alt=";)" title="Wink" /><!-- s;) --> I'll check it out, but it's like... seriously it's gotta be getting close to folding in on itself, or realizing it's swallowing it's own tail or whatever. Oops crazy talk. Will stop <!-- s;) --><img src="{SMILIES_PATH}/icon_e_wink.gif" alt=";)" title="Wink" /><!-- s;) -->
...
Posted by **PHLAK** on Mon August 15th, 2011 03:13:12 PM
